...
echo ""
echo "  # Terminal 2: Web con HTTPS"
echo "  HTTPS_LOCAL=true bun run --filter @payroll/web dev"
echo ""
echo "  # En tu navegador (admin):"
echo "  https://$IP:4321/facial"
echo ""
echo "  # En la tablet (kiosko):"
echo "  https://$IP:4321/kiosk/setup"
echo ""
echo "  Acepta la advertencia de certificado en el navegador."
echo ""
