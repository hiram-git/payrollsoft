/**
 * Proxy de rechazo. Body JSON `{ reason: string }`.
 *
 *   POST /api/employee-files/reject?id=UUID
 */
...
export const POST: APIRoute = async ({ request, cookies }) => {
  ...
  try {
    ...
    /* body vacío permitido — API valida */
  }

  const res = await fetch(`${API_URL}/employee-files/${id}/reject`, {
    method: 'POST',
    headers: {
