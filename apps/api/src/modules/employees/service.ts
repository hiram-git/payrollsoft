...
/** Próximo código correlativo del empleado (EMP0001, EMP0002, …). */
export function nextEmployeeCode(db: AnyDb): Promise<string> {
  return nextCorrelativeCode(db, 'employees', 'EMP')
}
