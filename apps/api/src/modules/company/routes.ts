...
const CompanyConfigBody = t.Object({
  ...
  patronalNumber: t.Optional(t.Nullable(t.String({ maxLength: 20 }))),
  entityCode: t.Optional(t.Nullable(t.String({ maxLength: 10 }))),
  entityName: t.Optional(t.Nullable(t.String({ maxLength: 255 }))),
